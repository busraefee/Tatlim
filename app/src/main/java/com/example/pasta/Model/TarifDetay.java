...
public class TarifDetay {

    //firebaseden tarif detay ile ilgili verileri çekebilmek için
    ...
    public TarifDetay(String gonderiId, String gonderiResmi, String gonderen, String yemekadi, String malzemeler, String yapilis) {
